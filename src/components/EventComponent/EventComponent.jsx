...
const EventComponent = () => {
  ...
  return (
    <div className="bg-cBrightBlue py-6 font-inter ">
      {/* Filters */}
      <div className="my-6 bg-cBrightBlue">
      ...
      {paginatedData.length === 0 && !isLoading ? (
        <div className="flex justify-center items-center min-h-screen bg-cBrightBlue">
          <div className="text-cWhite text-lg">
            No events found matching the current filter.
          </div>
        </div>
      ) : (
        <div className="w-full bg-cBrightBlue flex items-center justify-center my-8">
          {/* Events List */}
