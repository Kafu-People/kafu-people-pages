            ...
            <div className="p-6 flex flex-col items-center">
              ...
              <div className="mt-4 flex space-x-2">
                <button
                  ...
                  className="bg-cBrightBlue text-cWhite border border-cDarkBlue hover:bg-cWhite hover:text-cDarkBlue  px-4 py-2 rounded-lg hover:bg-yellow-600 transition duration-300 shadow-sm"
                >
                  Edit
                </button>
                <button
